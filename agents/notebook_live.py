...
Используй принципы Чалдини как этический контроль. Назови риски манипуляции,
ложной причинности, чтения мыслей, давления страхом/виной и скрытого авторитета.
Дай короткий список требований, при которых текст будет убедительным, но
сохранит свободу выбора читателя.""",
        "voice": common + """
