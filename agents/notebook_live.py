...
ОБЕЩАНИЕ ЧИТАТЕЛЮ:
ЛОГИЧЕСКИЙ ХОД: три коротких шага от наблюдения к различению и следствию
...
Предложи ровно три первые фразы с разной механикой: наблюдение, противоречие
и точный вопрос. Не повторяй исходную тему или её первые
