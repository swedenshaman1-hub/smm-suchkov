...
одно или два предложения должен понять, о какой человеческой ситуации речь,
увидеть конкретное действие или услышать живую фразу и почувствовать, что
поставлено на карту. Хук не может состоять только из абстракций вроде важных
