...
поста и краткая история недавних принятых текстов. У каждого советника только одна власть:
...
Следуй редакционной форме как направлению. История нужна только для того, чтобы
не повторять недавние входы, метафоры и финалы; не обсуждай её внутри поста.
